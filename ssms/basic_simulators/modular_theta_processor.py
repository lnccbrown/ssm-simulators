...
class ModularThetaProcessor(AbstractThetaProcessor):
    ...
    def _build_default_registry() -> ThetaProcessorRegistry:
        ...
        # ================================================================
        no_transform_models = [
            "glob", "ddm", "angle", "weibull",
            "ddm_hddm_base", "ddm_legacy",
            "levy", "levy_angle",
            "full_ddm", "full_ddm_legacy", "full_ddm_hddm_base",
            "ornstein", "ornstein_angle",
            "gamma_drift", "gamma_drift_angle",
        ]
        ...
        dynamic_drift_models = [
            "conflict_ds", "conflict_ds_angle",
            "conflict_dsstimflex", "conflict_dsstimflex_angle",
            "conflict_stimflex", "conflict_stimflex_angle",
            "conflict_stimflexrel1", "conflict_stimflexrel1_angle",
            "conflict_stimflexrel1_leak", "conflict_stimflexrel1_leak2",
            "shrink_spot", "shrink_spot_simple",
            "shrink_spot_extended", "shrink_spot_extended_angle",
        ...
        registry.register_model("ddm_st", [
        ...
        registry.register_model("ddm_rayleight", [
            LambdaTransformation(
                lambda theta, cfg, n: theta.update({
                    "z_dist": cfg["simulator_fixed_params"]["z_dist"],
                    "v_dist": cfg["simulator_fixed_params"]["v_dist"],
                    "t": (np.ones(n) * cfg["simulator_fixed_params"]["t"]).astype(np.float32),
                }) or theta,
        ...
        registry.register_model("ddm_truncnormt", [
            LambdaTransformation(
                lambda theta, cfg, n: theta.update({
                    "z_dist": cfg["simulator_fixed_params"]["z_dist"],
                    "v_dist": cfg["simulator_fixed_params"]["v_dist"],
        ...
        registry.register_model("ddm_sdv", [
            LambdaTransformation(
                lambda theta, cfg, n: theta.update({
                    "z_dist": cfg["simulator_fixed_params"]["z_dist"],
        ...
        registry.register_model("full_ddm_rv", [
        ...
        registry.register_model("lba2", [
            LambdaTransformation(lambda theta, cfg, n: theta.update({"nact": 2}) or theta, name="set_nact_2"),
        ...
        registry.register_model("lba3", [
            LambdaTransformation(lambda theta, cfg, n: theta.update({"nact": 3}) or theta, name="set_nact_3"),
        ...
        registry.register_model("lba_3_vs_constraint", [
            ColumnStackParameters(["v0", "v1", "v2"], "v", delete_sources=False),
            ExpandDimension(["a", "z"]),
            set_zero_t,
        ])
        ...
        for model in ["dev_rlwm_lba_race_v1", "dev_rlwm_lba_race_v2"]:
            registry.register_model(model, [
                ColumnStackParameters(["vRL0", "vRL1", "vRL2"], "vRL", delete_sources=False),
                ColumnStackParameters(["vWM0", "vWM1", "vWM2"], "vWM", delete_sources=False),
                ExpandDimension(["a", "z"]),
                set_zero_t,
            ])
        
        registry.register_model("dev_rlwm_lba_pw_v1", [
            ColumnStackParameters(["vRL0", "vRL1", "vRL2"], "vRL", delete_sources=False),
            ColumnStackParameters(["vWM0", "vWM1", "vWM2"], "vWM", delete_sources=False),
        ...
        # Specific variants
        registry.register_model("race_2", [
        ...
        registry.register_model("race_3", [
        ...
        registry.register_model("race_4", [
            ColumnStackParameters(["z0", "z1", "z2", "z3"], "z", delete_sources=False),
        ...
        add_mic2_adj_params = LambdaTransformation(
            lambda theta, cfg, n: (
                theta.update({
                    "s_pre_high_level_choice": np.tile(np.array([1.0], dtype=np.float32), n),
        ...
        add_ornstein_params_no_lowdim = LambdaTransformation(
            lambda theta, cfg, n: (
                theta.update({
                    "s_pre_high_level_choice": np.tile(np.array([0.0], dtype=np.float32), n)
                }) or theta
            ),
        ...
        for model in [
            ...
            registry.register_model(model, [add_z_defaults, add_ornstein_params_no_lowdim])
