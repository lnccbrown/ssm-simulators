...
class ResampleMixtureStrategy:
    ...
    def __init__(self, generator_config: dict, model_config: dict):
        """Initialize resample mixture strategy.
    ...
    def generate(
        ...
        if training_config["separate_response_channels"]:
        ...
        out[(n_kde + n_unif_up) :, -1] = training_config["negative_rt_log_likelihood"]
