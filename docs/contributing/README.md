...
the native contract directly. The guide explains the explicit source mapping,
omission-authority requirements, compatibility boundary, and links to the normative
schema reference.
