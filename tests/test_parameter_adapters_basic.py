...
class TestIndividualTransformations:
    ...
    def test_column_stack_parameters(self):
        ...
        theta = {"v0": np.array([0.5]), "v1": np.array([0.6]), "v2": np.array([0.7])}
    ...
    def test_column_stack_parameters_keep_sources(self):
        ...
        transform = ColumnStackParameters(["v0", "v1"], "v", delete_sources=False)
    ...
    def test_rename_parameter_with_transform(self):
        ...
        transform = RenameParameter(
            "A", "z", transform_fn=lambda x: np.expand_dims(x, axis=1)
        )
...
class TestRegistry:
    ...
    def test_register_family(self):
        ...
        registry.register_family(
            "race_2", lambda m: m.startswith("race_") and m.endswith("_2"), transforms
        )
    ...
    def test_exact_match_priority(self):
        ...
        registry.register_model("race_special_2", [SetDefaultValue("exact", 2)])
...
class TestTransformationPipelines:
    ...
    def test_transformation_sequence(self):
        ...
        theta = {"v0": np.array([0.5]), "v1": np.array([0.6]), "a": np.array([1.0])}
